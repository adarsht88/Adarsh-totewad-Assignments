...
let save1 = new SavingAccount("101", "Somi", 3343, 90);
console.log(save1.totalBalance());

var save2 = new SavingAccount("102","Jake",200,12);
console.log(save2.totalBalance);

let curr1 = new CurrentAccount("101", "Matin",4567,32);
console.log(curr1.totalBalance);

let curr2 = new CurrentAccount("104","Julie",54322,54);
